...
> 🌸 基于 AxManager 开发的精美分支，拥有完善的翻译和更好的交互体验。

**FolkPure** 是一款 Android 应用，旨在提供对应用和系统的深度控制。

作为 **AxManager** 的分支项目，FolkPure 专注于提供**优雅的用户界面**、**完善的多语言支持**和**流畅的交互体验**，为用户带来更好的使用感受。

与 *KernelSU* 或其他基于 root 权限的"管理器"等工具不同，**FolkPure** 专用于 **ADB/非 root 模式**，同时在设备拥有 **root 权限** 时，也允许执行命令。
...
- **[AxManager](https://github.com/fahrez182/AxManager)** - FolkPure 基于的原项目
